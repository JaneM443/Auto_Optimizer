...
{f"source /apps/intel/setvars.sh{newline}module load hpl/intel-final" if moduledata["Compilers"][0] == "intel" else f'module load {moduledata["BLAS Modules"][0]} {moduledata["MPI Modules"][0]} {moduledata["Compilers"][0]} '}
