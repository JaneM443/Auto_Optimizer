...
if USE_LOCAL_DATA == True:
    ...
    data = ({'Ns': [1000, 10000], 'NBs': [64, 256], 'Ps': [1, 8], 'Qs': [1, 8]}, {'BLAS Modules': ['openblas'], 'MPI Modules': ['openmpi'], 'Compilers': ['gcc']}, {'Max Runtime In Hours': ["03:00:00"], 'Number Of Nodes': [6], 'Cores Per Node Input': [12], 'Memory Per Node GB': [12]})
