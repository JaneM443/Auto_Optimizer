...
if USE_LOCAL_DATA:
    ...
    data = ({'Ns': [250_000, 250_001], 'Ps': [1, 2]}, {'BLAS Modules': ['openblas'], 'MPI Modules': ['openmpi'], 'Compilers': ['intel']}, {'Max Runtime In Hours': ["12:00:00"], 'Number Of Nodes': [70], 'Cores Per Node Input': [24], 'Memory Per Node GB': [128], 'Number Of Trials' : [1]})
