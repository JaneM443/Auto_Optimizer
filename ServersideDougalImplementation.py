...
if USE_LOCAL_DATA:
    ...
    data = ({'Ns': [760_000, 760_001], 'Ps': [10, 6]}, {'BLAS Modules': ['openblas'], 'MPI Modules': ['openmpi'], 'Compilers': ['intel']}, {'Max Runtime In Hours': ["12:00:00"], 'Number Of Nodes': [70], 'Cores Per Node Input': [24], 'Memory Per Node GB': [128], 'Number Of Trials' : [1]})
