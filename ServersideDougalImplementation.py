...
if USE_LOCAL_DATA == True:
    data = ({'Ns': [1, 2], 'NBs': [1, 2], 'Ps': [1, 2], 'Qs': [1, 2]}, {'BLAS Modules': ['a'], 'MPI Modules': ['a'], 'Compilers': ['a']}, {'Max Runtime In Hours': [12.0], 'Number Of Nodes': [12], 'Cores Per Node input': [12], 'Memory Per Node GB': [12]}, {'Ns' : 5, 'NBs' : 7, 'Ps' : 10, 'Qs' : 11})
