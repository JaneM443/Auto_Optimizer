...
if USE_LOCAL_DATA == True:
    data = ({'Ns': [1000, 10000], 'NBs': [64, 256], 'Ps': [1, 128], 'Qs': [1, 128]}, {'BLAS Modules': ['openblas'], 'MPI Modules': ['openmpi'], 'Compilers': ['gcc']}, {'Max Runtime In Hours': [3.0], 'Number Of Nodes': [1], 'Cores Per Node Input': [128], 'Memory Per Node GB': [12]})
